...
public interface ProyectoMapper {
    ...
    @Mapping(target = "estadoRevision", source = "estadoRevision", qualifiedByName = "estadoRevisionToString")
    ...
    @Named("estadoRevisionToString")
    static String estadoRevisionToString(EstadoRevision estado) {
