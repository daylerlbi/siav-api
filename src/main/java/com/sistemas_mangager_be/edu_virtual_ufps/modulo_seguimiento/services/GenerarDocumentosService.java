...
public class GenerarDocumentosService {
    ...
    public boolean generarSolicitudEvaluacionAnteproyecto(ActasInfoDto actasInfo, Integer idProyecto) {
        try {
            ...
            plantillaActa = new ClassPathResource("static/api/plantillas/SOLICITUD-EVALUACION-PROPUESTA.docx");
    ...
    public boolean generarCartaAprobacionAnteproyecto(ActasInfoDto actasInfo, Integer idProyecto) {
        try {
            ClassPathResource plantillaActa;
            plantillaActa = new ClassPathResource("static/api/plantillas/APROBACIÓN-ANTEPROYECTO-MAESTRÍA-TIC.docx");
    ...
    public boolean generarActaVistoBueno(ActasInfoDto actasInfo, Integer idProyecto) {
        try {
            ClassPathResource plantillaActa;
            plantillaActa = new ClassPathResource("static/api/plantillas/VISTO-BUENO-ANTEPROYECTO.docx");
    ...
    public boolean generarActaBorradorOFinal(boolean borrador, String formato, ActasInfoDto actasInfo, Integer idProyecto) {
        try {
            if (formato.equalsIgnoreCase("pdf")) {
                ClassPathResource plantillaActa;
                if (borrador) {
                    plantillaActa = new ClassPathResource("static/api/plantillas/actaBorrador.xhtml");
                } else {
                    plantillaActa = new ClassPathResource("static/api/plantillas/actaFinal.xhtml");
                }
                ...
                String contentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
                if (borrador) {
                    plantillaActa = new ClassPathResource("static/api/plantillas/ACTA-BORRADOR.docx");
                    nombreTemporal = UUID.randomUUID() + "_acta-borrador.docx";
                } else {
                    plantillaActa = new ClassPathResource("static/api/plantillas/ACTA-ORIGINAL.docx");
